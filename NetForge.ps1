    ...
    <Grid>
            ...
            <Grid>
                ...
                <StackPanel Grid.Column="0" Orientation="Horizontal" VerticalAlignment="Center">
                    ...
                    <Border Background="{StaticResource BgTertiaryBrush}" CornerRadius="4" Padding="8,4" Margin="16,0,0,0" VerticalAlignment="Center">
                        <TextBlock Text="v1.53.0" FontSize="11" Foreground="{StaticResource TextMutedBrush}"/>
                    </Border>
                </StackPanel>
        ...
        <Border Grid.Row="3" Background="{StaticResource BgSecondaryBrush}" BorderBrush="{StaticResource BorderBrush}" BorderThickness="0,1,0,0" Padding="16,10">
            <Grid>
                ...
                <TextBlock x:Name="txtFooterStatus" Grid.Column="1" Text="NetForge v1.53.0 | Running as Administrator" FontSize="11" Foreground="{StaticResource TextMutedBrush}" VerticalAlignment="Center"/>
            </Grid>
        </Border>
    </Grid>
</Window>
